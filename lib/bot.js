...
function buildSuggestionMessage(userProfile) {
    ...
    const SuggestionMessage = {
        "attachment": {
            ...
            "payload": {
                ...
                "elements": [
                    {
                        "title": "I might have someone for you",
                        "image_url": "https://static.pexels.com/photos/47554/pexels-photo-47554-large.jpeg",
                        "subtitle": "Hanna, 25",
                        "buttons": [
                            {
                                "type": "postback",
    ...
    Messenger.sendMessage(userProfile.profileId, SuggestionMessage, (err) => {
        if (err)
            return Messenger.reportSendErr(err)
    })
}
